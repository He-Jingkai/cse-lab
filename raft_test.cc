...
TEST_CASE(part2, fail_agree, "Fail Agreement")
{
    ...
    // std::cout<<"******************pass check_exact_one_leader******************"<<std::endl;
    group->disable_node(leader);
    // std::cout<<"******************disable leader "<<leader<<"******************"<<std::endl;
    ...
    // std::cout<<"******************pass 4 commands ******************"<<std::endl;
...
TEST_CASE(part2, fail_no_agree, "Fail No Agreement")
{
    ...
    // std::cout<<"******************pass disable******************"<<std::endl;
    ...
    // std::cout<<"******************pass is_leader******************"<<std::endl;
...
TEST_CASE(part2, rejoin, "Rejoin of partitioned leader")
{
    ...
    // std::cout<<"**************************make old leader try to agree on some entries**********************"<<leader1<<std::endl;
    ...
    group->disable_node(leader2);
    // std::cout<<"**************************new leader network failure**********************"<<leader2<<std::endl;
...
TEST_CASE(part2, backup, "Leader backs up quickly over incorrect follower logs")
{
    ...
    // std::cout<<"**************************allow other partition to recover********************** leader1 is "<<leader1<<std::endl;
    ...
    // std::cout<<"**************************begin begin **********************leader 2 is"<<leader2<<"other is"<<other<<std::endl;
...
TEST_CASE(part3, persist3, "Partitioned leader and one follower crash, leader restarts")
{
    ...
    int leader = group->check_exact_one_leader();
    group->disable_node((leader + 2) % num_nodes);
    // std::cout<<"disable node: "<<leader + 2<<std::endl;
...
TEST_CASE(part4, basic_snapshot, "Basic snapshot")
{
    ...
    leader = group->check_exact_one_leader();
    // std::cout << "pass here killed_node: "<<killed_node<< std::endl;
