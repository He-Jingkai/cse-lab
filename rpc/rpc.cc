...
// marshall &
// operator<<(marshall &m, mr_protocol::AskTaskResponse x)
// {
// 	m<<(unsigned int)x.type;
// 	m<<(int)x.index;
// 	m<<(std::string)x.filenames;
...
// unmarshall &
// operator>>(unmarshall &u, mr_protocol::AskTaskResponse  &s)
// {
// 	unsigned sz;
// 	unsigned int type;
// 	int index;
