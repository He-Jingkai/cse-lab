...
/* Macro for lab4 */
/*说明:
 * raft group的逻辑请见ch_db.cc中#if RAFT_GROUP内容 */
#define RAFT_GROUP 1        /* Use raft group for view server. Enable it in part2 */
/*说明:
 * big lock的逻辑请见ch_db.cc中#if BIG_LOCK内容
 * fine-grained lock的逻辑请见tx_region.cc中#if BIG_LOCK内容和acquireLock(),releaseLock()内容
 * 以及chdb.h中chdb::acquireLock(),chdb::releaseLock()内容
 * 有任何疑问请联系我(hjk020101@sjtu.edu.cn),感谢
 * */
